// ---------------------------------------------------------------
// Inline SVG icons (stroke = currentColor, so they inherit text
// color). Zero dependencies — no icon library needed for 3 icons.
// ---------------------------------------------------------------
export function CloudUploadIcon({ size = 28 }) {
  return (
